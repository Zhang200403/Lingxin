...
from library import main  #homework:to use the main fuction in the library, I import this from library.
...
#homewrok: I delete all the coding and move them to library.py ,so that the key is not exposed.
