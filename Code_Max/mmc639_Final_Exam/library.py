#homework:to use the fuction in the original code, I import the following packges/libries from the code.py
...
#to seal the key, I move the following code to the library.py
